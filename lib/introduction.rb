...
def introduction_with_language (name, languaje)
  puts "Hi, my name is #{name} and I am learning to program in #{languaje}."
end

def introduction_with_language_optional (name, languaje = 'Ruby')
  puts "Hi, my name is #{name} and I am learning to program in #{languaje}."
end
